...
public class SSixPointedStar extends SPolygon {
	...
	public void buildPolygon() {
		...
		this.yPolygon[8] = this.getLoc().y;
		this.xPolygon[9] = this.getLoc().x;
		this.yPolygon[9] = this.getLoc().y;
		this.xPolygon[10] = this.getLoc().x;
		this.yPolygon[10] = this.getLoc().y;
		this.xPolygon[11] = this.getLoc().x;
		this.yPolygon[11] = this.getLoc().y;
